...
public:
	...
	static void SendVirtualKeyboard(const std::string& key);
	...
	static void	EnableItemIcon( RwBool bEnable, RwInt32 ePlace, RwUInt32 uiSlotIdx, RwInt32 nPlaceIdx = -1 ); // peessi: nPlaceIdx�� WareHouse, Bag���� ����.
