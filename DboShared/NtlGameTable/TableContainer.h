...
public:
	enum eTABLE
	{
		...
		TABLE_RACE,
		TABLE_DROP_SUPERIOR,
		// TABLE_TEXT_SERVER already declared above (Text group) — reused for CTextServerTable
		TABLE_DROP_TYPE,
...
public:
	...
	// Create ��� �� pCall �� NULL �� ��� ������ ��İ� �����ϰ� �����Ѵ�. pCall -> Client ���� 
...
// Quest
	CQuestDropTable*				m_pQuestDropTable;		// ����Ʈ ��� ������ ���̺�

	CQuestItemTable*				m_pQuestItemTable;		// ����Ʈ ������ ���̺�
