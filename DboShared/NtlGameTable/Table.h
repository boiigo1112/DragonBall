...
public:
	...
	// V2 port helpers — used by table classes' ConvertTableTXT()/LoadFromTXT() dev-tool methods
	void			split(const std::wstring& s, std::vector<std::wstring>& elems);
	unsigned long	sti(std::wstring str);
...
protected:
	...
	//void						CheckNegativeInvalid(char* pszFormatString, BSTR bstr); // @�� ������ �ȵǴ� �ʵ�� Assert�� �ѷ��ش�.

	void						CheckNegativeInvalid(const wchar_t* pwszFormatString, BSTR bstr); // @�� ������ �ȵǴ� �ʵ�� Assert�� �ѷ��ش�.
